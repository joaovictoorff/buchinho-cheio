    ...
    <div class="container">
        <div class="item">
            ...
            <div class="controls">
                ...
                <input type="button" value="Adicionar" onclick="adicionarAoCarrinho('cafe', 'Café', 'src/images/cafe.png')">
            </div>
        </div>
        <div class="item">
            ...
            <div class="controls">
                ...
                <input type="button" value="Adicionar" onclick="adicionarAoCarrinho('arroz', 'Arroz', 'src/images/arroz.png')">
            </div>
        </div>
        <div class="item">
            ...
            <div class="controls">
                ...
                <input type="button" value="Adicionar" onclick="adicionarAoCarrinho('feijao', 'Feijão', 'src/images/feijao.png')">
            </div>
        </div>
        <div class="item">
            ...
            <div class="controls">
                ...
                <input type="button" value="Adicionar" onclick="adicionarAoCarrinho('macarrao', 'Macarrão', 'src/images/macarrao.png')">
            </div>
        </div>
        <div class="item">
            ...
            <div class="controls">
                ...
                <input type="button" value="Adicionar" onclick="adicionarAoCarrinho('acucar', 'Açúcar', 'src/images/acucar.png')">
            </div>
        </div>
        <div class="item">
            ...
            <div class="controls">
                ...
                <input type="button" value="Adicionar" onclick="adicionarAoCarrinho('farinha', 'Farinha de trigo', 'src/images/farinha.png')">
            </div>
        </div>
        <div class="item">
            ...
            <div class="controls">
                ...
                <input type="button" value="Adicionar" onclick="adicionarAoCarrinho('milho', 'Milho', 'src/images/milho.png')">
            </div>
        </div>
        <div class="item">
            ...
            <div class="controls">
                ...
                <input type="button" value="Adicionar" onclick="adicionarAoCarrinho('sardinha', 'Sardinha', 'src/images/sardinha.png')">
            </div>
        </div>
        <div class="item">
            ...
            <div class="controls">
                ...
                <input type="button" value="Adicionar" onclick="adicionarAoCarrinho('oleo', 'Óleo', 'src/images/oleo.png')">
            </div>
        </div>
        <div class="item">
            ...
            <div class="controls">
                ...
                <input type="button" value="Adicionar" onclick="adicionarAoCarrinho('sabonete', 'Sabonete', 'src/images/sabonete.png')">
            </div>
        </div>
        <div class="item">
            ...
            <div class="controls">
                ...
                <input type="button" value="Adicionar" onclick="adicionarAoCarrinho('pasta', 'Pasta de dente', 'src/images/pasta.png')">
            </div>
        </div>
        <div class="item">
            ...
            <div class="controls">
                ...
                <input type="button" value="Adicionar" onclick="adicionarAoCarrinho('escova', 'Escova de dente', 'src/images/escova.png')">
            </div>
        </div>
    </div>
...
>>>>>>> 4c3979deffc84448ba6dcd16e7ef18028f714464:alimentos_doaveis.html
